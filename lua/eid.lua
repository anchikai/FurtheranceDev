...
-- Chi Rho
EID:addCollectible(CollectibleType.COLLECTIBLE_CHI_RHO, "Lasers now home on enemies#They will stay put where they where fired, similarly to {{Collectible222}}Anti-Gravity#↓ They will only deal damage for 1 frame", "Chi Rho", "en_us")
